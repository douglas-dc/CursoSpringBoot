package com.douglasdc.cursomc.domain;
...
public class Cliente implements Serializable {
	...
	public Cliente(Integer id, String nome, String email, String cpfOuCnpj, TipoCliente tipo, String senha) {
		...
		this.tipo = (tipo == null) ? null : tipo.getCod(); //se o tipo for nulo, receberá valor nulo caso contrário receberá getCod
		this.senha = senha;
		addPerfil(Perfil.CLIENTE);
	}
	...
	public TipoCliente getTipo() {
		return TipoCliente.toEnum(tipo); //internamente armazena um número inteiro, externamente mostra a enum
	}
